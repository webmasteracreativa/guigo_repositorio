...
<div ng-app='FormCraft' style=''>
	<div id='formcraft-builder-cover' class='formcraft-css form-loading' ng-controller='FormController' ng-init='AngularInit()'>
		...
		<div id='add-fields-panel' class='fields-list-right fields-list-sortable show-{{Builder.Config.showAddField}}'>
			...
			<button draggable='true' ng-click='addFormElement("heading")'><?php _e('Heading','formcraft') ?></button>
			<button draggable='true' ng-click='addFormElement("oneLineText")'><?php _e('One Line Input','formcraft') ?></button>
			<button draggable='true' ng-click='addFormElement("email")'><?php _e('Email Input','formcraft') ?></button>
			<button draggable='true' ng-click='addFormElement("textarea")'><?php _e('Textarea','formcraft') ?></button>
			<button draggable='true' ng-click='addFormElement("checkbox")'><?php _e('Checkbox','formcraft') ?></button>
			<button draggable='true' ng-click='addFormElement("dropdown")'><?php _e('Dropdown','formcraft') ?></button>
			<button draggable='true' ng-click='addFormElement("datepicker")'><?php _e('Datepicker','formcraft') ?></button>
			<button draggable='true' ng-click='addFormElement("customText")'><?php _e('Custom Text','formcraft') ?></button>
			<button draggable='true' ng-click='addFormElement("submit")'><?php _e('Submit','formcraft') ?></button>
			<?php
			...
			<div class='hover-on-fields'>
				...
				<ul class='fields-list fields-list-sortable'>
					<li><button draggable='true' ng-click='addFormElement("password")'><?php _e('Password','formcraft') ?></button></li>
					<li><button draggable='true' ng-click='addFormElement("fileupload")'><?php _e('File Upload','formcraft') ?></button></li>
					<li><button draggable='true' ng-click='addFormElement("slider")'><?php _e('Slider','formcraft') ?></button></li>
					<li><button draggable='true' ng-click='addFormElement("timepicker")'><?php _e('Timepicker','formcraft') ?></button></li>
					<li><button draggable='true' ng-click='addFormElement("address")'><?php _e('Address','formcraft') ?></button></li>
			...
			<div class='hover-on-fields' style='z-index: 100'>
				...
				<ul class='fields-list fields-list-sortable'>
					<li><button draggable='true' ng-click='addFormElement("thumb")'><?php _e('Thumb Rating','formcraft') ?></button></li>
					<li><button draggable='true' ng-click='addFormElement("star")'><?php _e('Star Rating','formcraft') ?></button></li>
					<li><button draggable='true' ng-click='addFormElement("matrix")'><?php _e('Choice Matrix','formcraft') ?></button></li>
				</ul>
			</div>
				...
				<div class='active'>
					...
					<div class='ac-inner'>
						...
						<label class='single-option has-checkbox'>
							...
							<h3><?php _e('Remove Field Borders','formcraft'); ?></h3>
						</label>						
						<label class='single-option has-checkbox'>
	...
	<div class='form-cover-builder'>
		...
		<div class='form-cover'>
			...
			<div class='prev-next prev-next-{{Builder.FormElements.length}}' style='width: {{Builder.form_width}}; color: {{Builder.Config.font_color}}; font-size: {{Builder.font_size}}%; background: {{Builder.form_background}}'>
				<div><input type='text' ng-model='Builder.prevText'/><span class='inactive page-prev'><i class='formcraft-icon'>keyboard_arrow_left</i>{{Builder.prevText}}</span></div>
				<div><input type='text' ng-model='Builder.nextText'/><span class='page-next'>{{Builder.nextText}}<i class='formcraft-icon'>keyboard_arrow_right</i></span></div>
			</div>
		</div>
	</div>
</div>
...
<div class="fc_modal fc_fade" id="icons_modal">
	<div class="fc_modal-dialog">
		<div class="fc_modal-content">
			<div class="fc_modal-header">
				<button class='fc_close' type="button" class="close" data-dismiss="fc_modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="fc_modal-title"><?php _e('Select Icon','formcraft'); ?></h4>
			</div>
			<div class='fc_modal-body'>
				<label class='icon-parent-label formcraft-icon-type-{{icon.Value}}' ng-repeat='icon in listIcons'>
					<input ng-click='selectIcon(icon.Value)' type='radio' name='{{element.elementDefaults.identifier}}_icon' update-label ng-model='element.elementDefaults.selectedIcon' value='{{icon.Value}}'/><i class='formcraft-icon'>{{icon.Value}}</i>
				</label>				
			</div>
		</div>
	</div>
