...
if (!function_exists('create_post_type')) {
	function create_post_type() {
		...
		register_post_type( 'portfolio_page',
			array(
				'labels' => array(
					'name' => __( 'Usados','qode' ),
					'singular_name' => __( 'Inmueble Usado','qode' ),
					'add_item' => __('Añadir Inmueble Usado','qode'),
					'add_new_item' => __('Nuevo Inmueble Usado','qode'),
					'edit_item' => __('Editar Inmueble Usado','qode')
				),
				'public' => true,
				'has_archive' => true,
	...
	/* Create Portfolio Categories */
	  ...
	  $labels = array(
			'name' => __( 'Categorias Usados', 'qode' ),
			'singular_name' => __( 'Categorias usados', 'qode' ),
			'search_items' =>  __( 'Buscar categorias usados','qode' ),
			'all_items' => __( 'Todas las categorias de Usados','qode' ),
			'parent_item' => __( 'Categoría padre','qode' ),
			'parent_item_colon' => __( 'Categoría padre:','qode' ),
			'edit_item' => __( 'Editar categoría','qode' ),
			'update_item' => __( 'Actualizar categoría','qode' ),
			'add_new_item' => __( 'Añadir nueva categoría','qode' ),
			'new_item_name' => __( 'Nueva categoría','qode' ),
			'menu_name' => __( 'Categorías','qode' ),
	  );
	...
	/* Create Portfolio Tags */
		...
		$labels = array(
			'name' => __( 'Usados Tags', 'qode' ),
			'singular_name' => __( 'Usados Tag', 'qode' ),
			'search_items' =>  __( 'Buscar Usados Tags','qode' ),
			'all_items' => __( 'Todos los Tags','qode' ),
			'parent_item' => __( 'Parent Usados Tag','qode' ),
			'parent_item_colon' => __( 'Parent Usados Tags:','qode' ),
			'edit_item' => __( 'Edit Usados Tag','qode' ),
			'update_item' => __( 'Update Usados Tag','qode' ),
			'add_new_item' => __( 'Add New Usados Tag','qode' ),
			'new_item_name' => __( 'New Usados Tag Name','qode' ),
			'menu_name' => __( 'Tags','qode' ),
		);
	...
	/* Create Carousel Category
	  ...
	  register_taxonomy('carousels_category',array('carousels'), array(
		...
		$labels = array(
			'name' => __( 'Masonry Gallery Categories', 'qode' ),
			'singular_name' => __( 'Masonry Gallery Category', 'qode' ),
