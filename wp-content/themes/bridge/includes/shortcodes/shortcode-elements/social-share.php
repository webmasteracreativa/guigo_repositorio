            ...
            if(isset($qode_options_proya["post_types_names_$post_type"])) {
                if($qode_options_proya["post_types_names_$post_type"] == $post_type) {
                    ...
                    if($show_share_icon == 'yes'){
                        $html .= '<i class="'.qode_icon_collections()->getSocialShareIcon($social_share_icon_pack).' social_share_icon"></i>';
                    }
...
if ( ! function_exists( 'qode_get_social_share_html' ) ) {
	/**
	 ...
	 * @return mixed|string
	 */
	function qode_get_social_share_html( $params = array() ) {

		return qode_execute_shortcode( 'social_share', $params );
