...
if(!function_exists('qode_fonts_options_map')) {
    ...
    function qode_fonts_options_map(){
		...
		$page_title_texttransform = new QodeField("selectblanksimple", "page_title_texttransform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$row2 = new QodeRow();
		$group2->addChild("row2", $row2);
		$page_title_medium_texttransform = new QodeField("selectblanksimple", "page_title_medium_texttransform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$row2 = new QodeRow();
		$group3->addChild("row2", $row2);
		$page_title_large_texttransform = new QodeField("selectblanksimple", "page_title_large_texttransform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		$row2->addChild("page_title_large_texttransform", $page_title_large_texttransform);

        // Page Title Responsive

        $panel_title_responsive = new QodePanel("Page Title Responsive", "panel_title_responsive");
        $fontsPage->addChild("panel_title_responsive", $panel_title_responsive);

        $small_group = qode_add_admin_group(array(
            'name'          => 'small_group',
            'title'         => esc_html__('Small Title', 'qode'),
            'description'   => esc_html__('Setup responsive font options for small title', 'qode'),
            'parent'        => $panel_title_responsive
        ));

        $tablet_row = qode_add_admin_row(array(
            'name' => 'tablet_row',
            'next' => true,
            'parent' => $small_group
        ));
        ...
        qode_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Font Size for Tablet portrait', 'qode'),
            'description'   => ''
        ));
        ...
        qode_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Line Height for Tablet portrait', 'qode'),
            'description'   => ''
        ));

        $mobile_row = qode_add_admin_row(array(
            'name' => 'mobile_row',
            'parent' => $small_group
        ));
        ...
        qode_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Font Size for Mobile', 'qode'),
            'description'   => ''
        ));
        ...
        qode_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Line Height for Mobile', 'qode'),
            'description'   => ''
        ));

        $medium_group = qode_add_admin_group(array(
            'name'          => 'medium_group',
            'title'         => esc_html__('Medium Title', 'qode'),
            'description'   => esc_html__('Setup responsive font options for medium title', 'qode'),
            'parent'        => $panel_title_responsive
        ));
        ...
        $large_group = qode_add_admin_group(array(
            'name'          => 'large_group',
            'title'         => esc_html__('Large Title', 'qode'),
            'description'   => esc_html__('Setup responsive font options for large title', 'qode'),
            'parent'        => $panel_title_responsive
        ));
