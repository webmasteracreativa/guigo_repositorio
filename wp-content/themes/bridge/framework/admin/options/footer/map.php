...
if(!function_exists('qode_footer_options_map')) {
    ...
    function qode_footer_options_map()
    {
        ...
        qode_add_admin_field( array(
                ...
                'description'   => esc_html__('Choose a width at which advanced responsive options will take effect. This will make footer columns go 2 by 2 under selected width.', 'qode'),
