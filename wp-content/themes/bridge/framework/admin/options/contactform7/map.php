...
if(!function_exists('qode_contactform7_options_map')) {
    ...
    function qode_contactform7_options_map()
    {
        ...
        $cf7_custom_style_1_element_enable_border_bottom = new QodeField("yesnosimple", "cf7_custom_style_1_element_enable_border_bottom", "no", "Enable only bottom border","This is some description");
        ...
        $row2 = new QodeRow();
        $group2->addChild("row2", $row2);
        $cf7_custom_style_2_element_enable_border_bottom = new QodeField("yesnosimple", "cf7_custom_style_2_element_enable_border_bottom", "no", "Enable only bottom border","This is some description");
        ...
        $row2 = new QodeRow();
        $group2->addChild("row2", $row2);
        $cf7_custom_style_3_element_enable_border_bottom = new QodeField("yesnosimple", "cf7_custom_style_3_element_enable_border_bottom", "no", "Enable only bottom border","This is some description");
