    ...
    function qode_general_options_map(){
        ...
        qode_add_admin_field(
            array(
                ...
                'type'          => 'checkboxgroup',
                'default_value' => $qode_options_proya['qode_ui_scripts_default_value'],
                'label'         => esc_html__( 'JQuery Scripts ', 'qode' ),
                'description'   => esc_html__( 'Choose which JQuery scripts will be loaded for your site. By default, all scripts are loaded initially', 'qode' ),
                'parent'        => $panel4,
                'options'       => $qode_options_proya['qode_ui_scripts']
            )
        );
