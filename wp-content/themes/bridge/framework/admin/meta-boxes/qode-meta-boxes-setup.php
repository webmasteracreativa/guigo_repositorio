...
function qode_meta_boxes_map_init() {
	...
	require_once("post/post-format-audio/map.php");
	require_once("post/post-format-gallery/map.php");
	require_once("post/post-format-link/map.php");
	require_once("post/post-format-quote/map.php");
	require_once("post/post-format-video/map.php");
