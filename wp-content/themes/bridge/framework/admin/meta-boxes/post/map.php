...
if(!function_exists('qode_map_post_meta_fields')) {
	...
	function qode_map_post_meta_fields() {
		...
		$qode_post_style_masonry_date_image = new QodeMetaField("select","qode_post_style_masonry_date_image","","Dimensions of image for Blog Masonry","Choose post image dimensions for Blog Masonry and Blog Masonry - Date in Image template",array(
			"full" => "Default",
			"landscape" => "Landscape",
			"portrait" => "Portrait",
			"square" => "Square"
