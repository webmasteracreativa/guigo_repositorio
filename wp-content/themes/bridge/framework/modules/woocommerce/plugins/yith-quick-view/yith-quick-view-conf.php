...
add_action('yith_wcqv_product_summary', 'qode_woocommerce_share_wish_tag_before', 30);
add_action('yith_wcqv_product_summary', 'qode_woocommerce_share_wish_tag_after', 35);
